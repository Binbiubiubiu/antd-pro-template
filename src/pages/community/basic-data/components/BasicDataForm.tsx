...
export interface FormValueType extends Partial<VillageTableForm> {}

export interface BasicDataFormProps extends FormComponentProps {
  onCancel: () => void;
...
class BasicDataForm extends Component<BasicDataFormProps, BasicDataFormState> {
  static defaultProps = {
    onSubmit: () => {},
    formVals: {},
  };
...
export default Form.create<BasicDataFormProps>()(BasicDataForm);
