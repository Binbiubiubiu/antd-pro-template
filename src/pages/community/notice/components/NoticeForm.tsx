...
export interface FormValueType extends Partial<NoticeTableForm> {}

export interface NoticeFormProps extends FormComponentProps {
  onCancel: () => void;
...
class NoticeForm extends Component<NoticeFormProps, NoticeFormState> {
  static defaultProps = {
    onSubmit: () => {},
    formVals: {},
  };
