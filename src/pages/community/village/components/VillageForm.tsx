...
export interface VillageFormProps extends FormComponentProps {
  onCancel: () => void;
...
class VillageForm extends Component<VillageFormProps, VillageFormState> {
  static defaultProps = {
    onSubmit: () => {},
    formVals: {},
  };
...
export default Form.create<VillageFormProps>()(VillageForm);
